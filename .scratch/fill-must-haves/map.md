...
- P5 其余：OCR 真引擎 / Cloud OCR、容量、熔断生产调优、在线抽样常态化、CoVe / 超长异步、启动自动全库 needs_ocr 重跑
