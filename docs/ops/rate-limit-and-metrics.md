...
| 指标名例 | `ask_total` / `ask_ok` / `ask_fail` · `llm_call_total` · `rerank_total` · `ask_rate_limited_total` · `l3_rewrite_used_total` / `l3_coref_fail_total` / `l3_session_ask_total` / `l3_session_deepened_total` |
