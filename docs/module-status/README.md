...
| **会话外壳** | **可演示**（列表 / 历史回放；**rewrite 图边已落、默认关**；**显式回溯加深部分**；**≠** 准出 / **≠** 对外连续追问） | `api` | `web` · `db` · `contracts` | [api](./api.md) · [web](./web.md) |
