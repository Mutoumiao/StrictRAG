...
| **admin 运营面** | **可演示**（S2c + B1–B6 最小 + B7 裁剪 + **B13 反馈队列** + **评测底线**；设置页含修改日志；落地 href **12** 条；面板只读、非 APM / **≠** 签字包） | `admin` | `api` · `admin-catalog` · `contracts` | [admin](./admin.md) · [admin-catalog](./admin-catalog.md) |
