...
| 最近更新 | 2026-09-08（L1 Hit@k 纯函数；EvalRun 可选 hitAtK） |
...
- **黄金集 / run DTO**：eval/gold.contract.ts · eval/eval-run.contract.ts；2×2 与 Hit@k 纯函数 eval/l1-matrix.ts；EvalRun 可选 `hitAtK` / `hitAtKHits` / `hitAtKScored`；L2 解析 eval/l2-gold.ts · 工程公式 eval/l2-matrix.ts
