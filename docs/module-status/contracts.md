...
| 最近更新 | 2026-09-08（L1 τ 扫描纯函数；EvalRun 可选 tauStar） |
...
- **黄金集 / run DTO**：eval/gold.contract.ts · eval/eval-run.contract.ts；2×2、Hit@k 与 τ 扫描纯函数 eval/l1-matrix.ts；EvalRun 可选 `hitAtK` / `hitAtKHits` / `hitAtKScored` / `tauStar`；L2 解析 eval/l2-gold.ts · 工程公式 eval/l2-matrix.ts
