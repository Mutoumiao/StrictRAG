...
| [ingest](./coverage/01-ingest.md) | 53 | 10 | 33 | 0 | 6 | 4 | 0 |
| [acl](./coverage/02-acl.md) | 69 | 22 | 37 | 2 | 1 | 4 | 3 |
| [ops](./coverage/03-ops.md) | 93 | 21 | 29 | 1 | 10 | 23 | 9 |
| **合计** | **279** | **77** | **125** | **3** | **18** | **42** | **14** |
...
P2 必签但 **缺实现** 的（不写假装测；已挂 QUAL-* task）：K5→QUAL-K5、E4→QUAL-E4、E5→QUAL-E5、L7→QUAL-L7、V3→QUAL-V3、AA1→QUAL-AA1、B1-A4→QUAL-ACL-CAP、O4→QUAL-TENANT-Q、R4–R10→QUAL-PLANE、G3→QUAL-G3（运营表回流已部分测；**gold.yaml** 审核闸仍缺）、AB8→QUAL-AB8、AC7→QUAL-AC7。AD1–AD3 引导已测（wayfinder 启动引导超管）。M7 仍归 QUAL-2。详见各分册。
