...
- [ ] `GET …/doc-types` 是否成员闸、只回启用项 `{ items }`（真 label）、**禁止**漏 τ / 停用码（web 关闭列表读枚举；设置 GET 仍 `kb.config.write`）？  
...
| [dashboard](./dashboard.md) | **B6 数据面板薄壳** · `dashboard.view` · 只读 summary ≤5 · I4 tracks 质量/延迟独立信封 · **≠** APM / **≠** 准出 |
