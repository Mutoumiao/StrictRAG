...
- [ ] 改 eval 消费者时是否只跑 L1 golden / L2 fixtures、写 `eval_runs`、L1 有 expectedDocIds 时写 Hit@k、有 minSupport 时写 tauStar、**禁止** import api / 宣称签字或准出 PASS / 把 Hit@k 或 tau* 当签字公式 / 写 `TAU_CLAIM`？  
