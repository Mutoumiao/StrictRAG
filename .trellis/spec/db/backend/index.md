...
> 现状：schema_meta + KB/文档/chunk/manifest/embed/ingest_jobs；migrate 在 `drizzle/`。
...
- [ ] `pnpm --filter @strict-rag/db check-types`  
...
| 指南 | 说明 |
|------|------|
| [directory-structure](./directory-structure.md) | 目标目录与现状 |
